...
class PanResponderDemo extends React.Component{
	...
	componentWillMount(){
		this._panResponder = PanResponder.create({
			onStartSouldSetPanResponder: this._handleStartSouldSetPanResponder,
			onMoverShouldSetPanResponder: this._handleMoveShouldSetPanResponder,
	...
	_handleStartSouldSetPanResponder = (e: Object, gestureState: Object)=>{
		return true;
	}
